...
function () {
  ...
  _createClass(TodoApp, [{
    ...
    key: "addEventsDragAndDrop",
    value: function addEventsDragAndDrop(el) {
      el.addEventListener('dragstart', dragStart, false); // el.addEventListener('dragenter', dragEnter, false);

      el.addEventListener('dragover', dragOver, false); // el.addEventListener('dragleave', dragLeave, false);

      el.addEventListener('drop', dragDrop, false); // el.addEventListener('dragend', dragEnd, false);
    }
  }, {
    key: "addTodoItem",
